"use client"; // Add "use client" for components using hooks like useWorkspace
...
import { useWorkspace } from "@/contexts/WorkspaceContext"; // Assuming this path is correct after copy
              ...
              <CardContent>
                <div className="space-y-4">
                  ...
                  <Button size="sm" asChild className="w-full bg-gradient-to-r from-blue-500 to-purple-600 hover:from-blue-600 hover:to-purple-700 text-white border-0">
                    <Link href={`/generate?agent=${agent.id}`}>
