...
import { FileText, Zap, Scale, Gavel } from "lucide-react";
import { useRouter } from "next/navigation"; // Changed from react-router-dom

export default function WelcomePage() { // Renamed component
      ...
      <Card className="w-full max-w-2xl">
        ...
        <CardContent className="space-y-6">
          ...
          <div className="text-center pt-6">
            <Button
              onClick={() => router.push("/onboarding/legal-profile")} // Changed to router.push
              size="lg"
