...
import { toast } from "@/hooks/use-toast"; // Assuming path is correct
import { useAuth } from "@/hooks/useAuth"; // Assuming path is correct
import { useFormValidation } from "@/hooks/useFormValidation"; // Assuming path is correct
import { loginSchema, type LoginFormData } from "@/schemas/validationSchemas"; // Assuming path is correct
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      if (isSignUp) {
        ...
        router.push("/onboarding"); // Changed to router.push
      } else {
