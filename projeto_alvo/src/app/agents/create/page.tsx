...
import { ArrowLeft, Upload, Bot, CheckCircle, Lightbulb, Sparkles, Crown, Building2 } from "lucide-react";
...
export default function CreateAgent() {
        ...
        <Card className="w-full max-w-md">
          <CardContent className="pt-6 text-center">
            ...
            <Button asChild className="w-full">
              <Link href="/workspace">Configurar Meu Escritório</Link>
            </Button>
          </CardContent>
        </Card>
      </div>
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      ...
      router.push(`/dashboard?workspace=${selectedWorkspace!.id}`);
    }, 3000);
  };
